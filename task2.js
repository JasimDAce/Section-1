...
if(isPrime)
    console.log(`Yes, ${primeNumber} is a Prime Number`);
else
    console.log(`No,  ${primeNumber} is not a Prime Number`);
...
let isPalindrome = isPalindromeNumber(palindromeString,0,palindromeString.length-1);
if(isPalindrome)
    console.log(`Yes, ${palindrome} is a Palindrome Number`);
else
    console.log(`No, ${palindrome} is not a Palindrome Number`);
